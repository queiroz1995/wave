    ...
    return (
        <div className="w-full max-w-md mx-auto space-y-3 animate-in fade-in slide-in-from-bottom-8 duration-1000 px-1 pb-4">
            ...
            <div className="flex items-center justify-between px-1">
                <div className="flex items-center gap-2 bg-slate-950/60 backdrop-blur-xl p-1 pr-2.5 rounded-full border border-white/10">
                    <div className={cn(
                            ...
                            <div className="relative group">
                                ...
                                <div className="h-10 w-10 bg-slate-900 rounded-lg p-0.5 shadow-2xl border border-white/10 overflow-hidden">
                                    {selectedAIInfo?.image ? (
                                        <img src={selectedAIInfo.image} alt="" className="w-full h-full object-cover rounded-md" />
                                    ) : (
                    ...
                    <div className="space-y-2.5 pt-2 border-t border-white/5">
                        <div className="flex items-center justify-between px-1">
                            <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1">
                                <Sparkles className="h-2.5 w-2.5 text-cyan-400" /> Sinal de Entrada Manual
                            </span>
            ...
            {isBotRunning && (
                <div className="relative group">
                    ...
                    <div className="relative bg-slate-950/60 backdrop-blur-xl rounded-xl p-3 flex items-start gap-2.5 border border-white/10 shadow-2xl">
            ...
            <div className="bg-slate-950/60 backdrop-blur-xl border border-white/10 rounded-[1.5rem] p-3.5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)]">
                <div className="flex items-center justify-between mb-3 px-1">
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Feed de Operações</span>
                    </div>
                    <Button variant="ghost" size="icon" className="h-7 w-7 rounded-lg bg-white/5 hover:bg-white/10 border border-white/5" onClick={resetOperations}>
                ...
                <ScrollArea className="h-36 pr-1">
                    <div className="space-y-1.5">
                        {signals.length > 0 ? signals.map((s: any) => {
                            ...
                            return (
                                <div key={s.id} className="group relative flex items-center justify-between p-2 bg-slate-900/40 hover:bg-slate-900/80 rounded-lg border border-white/5 transition-all duration-300">
                                    <div className="flex items-center gap-2">
                                        <span className="text-[8px] font-mono text-slate-500">{s.timestamp}</span>
                                        <div className={cn("px-1.5 py-0.5 rounded text-[8px] font-black uppercase border transition-all duration-300", label.color)}>
                                            {label.text}
                                        </div>
                                    </div>
                                    <div className={cn(
                            ...
                            <div className="py-8 text-center">
                                ...
                                <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.4em] italic">Aguardando gatilhos neurais...</p>
                            </div>
                        )}
                    </div>
                </ScrollArea>
