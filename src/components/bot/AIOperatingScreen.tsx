            ...
            <Card className="bg-white/80 backdrop-blur-2xl border-white/40 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.1)] rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden relative">
                ...
                <CardContent className="p-6 sm:p-8 space-y-6 sm:space-y-8">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-1">
                            <SettingsSheet trigger={
                                <Button variant="ghost" size="icon" className="h-9 w-9 sm:h-10 sm:w-10 rounded-2xl bg-gray-50/50">
                                    <FileSpreadsheet className="h-4 w-4 text-muted-foreground" />
                                </Button>
                            } />
                            <Button variant="ghost" size="icon" className="h-9 w-9 sm:h-10 sm:w-10 rounded-2xl bg-red-50 text-red-500 hover:bg-red-100" onClick={exitToSelection}>
                    ...
                    <div className="bg-gray-50/50 border border-gray-100 rounded-[2rem] sm:rounded-[2.5rem] p-4 sm:p-6 flex items-center justify-between">
                        <div className="flex items-center gap-3 sm:gap-4">
                            <div className={cn(
                                "p-2.5 sm:p-3.5 rounded-2xl shadow-inner",
                        ...
                        <Button variant="ghost" size="icon" className="h-10 w-10 sm:h-12 w-12 rounded-2xl bg-white shadow-sm border border-gray-100" onClick={() => handleConnect(accountType, currentToken)}>
