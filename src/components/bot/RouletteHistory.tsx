...
export const RouletteHistory = () => {
    ...
    // Mostra exatamente os 50 mais recentes que estão no estado
    ...
    return (
        <div className="space-y-6">
            <Card className="bg-card/80 backdrop-blur-sm border-primary/20">
                ...
                <CardContent>
                    <div className="bg-muted/20 rounded-lg p-4 max-h-[500px] overflow-y-auto custom-scrollbar">
                        <div className="grid grid-cols-5 sm:grid-cols-10 gap-2">
                            ...
                            {displayHistory.length === 0 && (
                                <div className="col-span-full py-10 text-center text-muted-foreground text-xs">
                                    Buscando histórico de resultados recentes...
                                </div>
                            )}
                        </div>
                    </div>
