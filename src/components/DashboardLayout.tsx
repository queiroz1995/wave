...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
    ...
    return (
        <div className="min-h-screen bg-[#0a1128] text-white selection:bg-indigo-500/30 overflow-x-hidden relative">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <header className="w-full max-w-4xl flex justify-between items-center py-8 px-6">
                    <div className="flex items-center gap-3">
                        <div className="p-2.5 bg-white/10 border border-white/20 rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.2)]">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-1.5">
                                <div className="h-1.5 w-1.5 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_8px_rgba(34,211,238,1)]" />
                                <span className="text-[8px] font-bold uppercase tracking-[0.2em] text-cyan-400/80">System Active</span>
                            </div>
                        </div>
                    </div>

                    <div className="flex items-center gap-6 px-6 py-3 bg-white/10 border border-white/10 rounded-2xl backdrop-blur-md shadow-lg">
                        <div className="text-center">
                            <p className="text-[8px] font-bold text-slate-300 uppercase tracking-widest mb-0.5">Profit</p>
                            <p className={cn("text-sm font-black", totalProfit >= 0 ? 'text-emerald-400 drop-shadow-[0_0_8px_rgba(52,211,153,0.4)]' : 'text-rose-400')}>
                                ${totalProfit.toFixed(2)}
                            </p>
                        </div>
                        <Separator orientation="vertical" className="h-6 bg-white/20" />
                        <div className="text-center">
                            <p className="text-[8px] font-bold text-slate-300 uppercase tracking-widest mb-0.5">Win Rate</p>
                ...
                <footer className="w-full py-8 flex flex-col items-center gap-4 opacity-60">
